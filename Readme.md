...
[![GitHub Stars](https://img.shields.io/github/stars/hasindu-nagolla/aeraBot?style=for-the-badge)](https://github.com/hasindu-nagolla/aeraBot/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/hasindu-nagolla/aeraBot?style=for-the-badge)](https://github.com/hasindu-nagolla/aeraBot/network/members)
...
```bash
git clone https://github.com/hasindu-nagolla/aeraBot.git
```
...
docker run -d \
  ...
  --env-file .env \
  -v ./aera/cookies:/app/aera/cookies \
...
| Platform | Link |
|----------|------|
| 💻 GitHub Repository | https://github.com/hasindu-nagolla/aeraBot |
