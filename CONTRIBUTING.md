...
First of all, thank you for your interest in contributing to **aeraBot**! ❤️
...
Have an idea that could improve **aeraBot**?
...
```bash
git clone https://github.com/<your-username>/aeraBot.git
