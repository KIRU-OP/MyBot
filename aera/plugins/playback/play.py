...
from aera import tune, app, config, db, lang, queue, spotify, tg, yt
from aera.helpers import buttons, utils
from aera.helpers._play import checkUB
import asyncio
import logging
import re
    ...
    try:
        ...
        if "bot" in error_msg.lower() or "sign in" in error_msg.lower():
            await safe_edit(
                ...
                "Solution:\n"
                "• Update YouTube cookies in `aera/cookies/` folder\n"
