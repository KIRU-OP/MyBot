...
from aera.core.bot import Bot
app = Bot()

# Ensure required directories exist
from aera.core.dir import ensure_dirs
ensure_dirs()

# Initialize userbot/assistant clients
from aera.core.userbot import Userbot
userbot = Userbot()

# Initialize database connection
from aera.core.mongo import MongoDB
db = MongoDB()

# Initialize language system
from aera.core.lang import Language
lang = Language()

# Initialize Telegram, YouTube, and Spotify utilities
from aera.core.telegram import Telegram
from aera.core.youtube import YouTube
from aera.core.spotify import Spotify
tg = Telegram()
yt = YouTube()
spotify = Spotify()

# Initialize preload manager for background track downloading
from aera.core.preload import PreloadManager
preload = PreloadManager()

# Initialize queue manager
from aera.helpers import Queue
queue = Queue()

# Initialize call handler
from aera.core.calls import TgCall
tune = TgCall()
