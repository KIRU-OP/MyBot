...
We take the security of **aeraBot** seriously. We appreciate your efforts to responsibly disclose any security vulnerabilities you find.
...
To ensure you have the latest security patches and features, we strongly recommend running the latest stable release of **aeraBot**.
...
As **aeraBot** is a self-hosted Telegram bot, users are responsible for implementing critical security practices:
