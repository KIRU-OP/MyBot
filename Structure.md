...
## 📦 aera/ - Main Application Package

The core bot application containing all functionality.

### 🔧 aera/core/ - Core Components
...
### 🛠️ aera/helpers/ - Helper Functions
...
### 📦 aera/**init**.py - Package Initialization

Initializes and exports core components:

```python
from aera.core import app, userbot, tune, db, yt, logger
from aera import config
```
...
```python
from aera import app, userbot, tune, db, config, logger
```

**Helper imports:**

```python
from aera.helpers import buttons, thumb, utils
from aera.helpers import is_admin, Queue, Track
```
